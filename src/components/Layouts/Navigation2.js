                ...
                <div className="pt-2 col" style={{ left: '0', top: '0' }}>
                    {open ? (
                        ...
                        <button
                            ...
                            type="button"
                            onClick={logout}>
                            <i className="fad fa-sign-out h3 m-0 text-warning"></i>
                        </button>
                    )}
                ...
                <div
                    ...
                    <nav className="navigation bg-light-kudasai pt-2 d-flex align-items-center justify-content-md-center px-lg-0 px-2">
                        <div className="nav-item px-1">
                            <button
                                className="btn px-2 py-0 rounded"
                                id="OmnichannelButton">
                                My Channel
                            </button>
                        </div>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <h6 className="m-0 p-2">
                                Omnichannel is a neologism portmanteau
                                describing a business strategy. According to
                                Frost & Sullivan, omnichannel is defined as
                                "seamless and effortless, high-quality customer
                                experiences that occur within and between
                                contact channels".
                            </h6>
                        </div>
